  ...
  <div>
        ...
        <el-table-column label="操作" width="180">
            <template slot-scope="scope">
                ...
                <el-button
                  size="mini"
                  type="danger"
                  @click="deleteUser(scope.row.userId)">删除
                </el-button>
            </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addUser(addFormData)">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      title="编辑用户"
      ...
      width="50%">
      <el-form :model="updateuser" :rules="formRules" ref="updateadmin" label-width="100px" class="demo-ruleForm">
        <el-form-item label="用户编号" prop="userId">
...
export default {
    ...
    methods: {
      ...
      addUser(addFormData){
        ...
        _this.postRequest("/user/addUser", {
            user: addFormData
        }).then(resp => {
          this.$message({
          message: "添加成功",
      ...
      deleteUser(userId) {
        ...
        _this.$confirm('此操作将永久删除该用户, 是否继续?', '提示', {
                    ...
                    _this.deleteRequest("/user/deleteUser?userId=" + _this.userId).then(resp => {
                       _this.$message({
                          message: "删除成功",
                          type: "success"
                        });
